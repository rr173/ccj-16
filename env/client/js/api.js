...
export const api = {
  ...
  releaseRequestDetail: (rid) => request('GET', `/api/release-requests/${rid}`),
  ...
  releaseReopen: (rid, payload) => request('POST', `/api/release-requests/${rid}/reopen`, payload),
  approvalPolicyGet: (id) => request('GET', `/api/projects/${id}/approval-policy`),
  approvalPolicyPut: (id, payload) => request('PUT', `/api/projects/${id}/approval-policy`, payload),
